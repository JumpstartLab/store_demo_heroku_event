...
Product.create( title: "Bobby", 
                description: "Marcy's triplet brother. He's kind of smelly.", 
                price: 14.19, 
                status: 'active', 
                image_path: '/images/creatures/stickers/bobby-02.png')

Product.create( title: "Ruby (green)", 
                description: "We <3 it.", 
                price: 120.19, 
                status: 'active', 
                image_path: '/images/creatures/stickers/ruby-green.png')
